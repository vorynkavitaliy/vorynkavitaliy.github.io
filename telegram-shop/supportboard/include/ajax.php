...
switch ($_POST['function']) {
    ...
    case 'get-active-user':
        die(sb_json_response(sb_get_active_user(sb_post('db'), sb_post('login_app'))));
    case 'get-agent':
    ...
    case 'woocommerce-get-user-orders':
        die(sb_json_response(sb_woocommerce_get_user_orders(sb_post('user_id'))));
...
function sb_security() {
    ...
    $security = [
        ...
        'login' => ['woocommerce-shipping-locations', 'woocommerce-payment-methods', 'woocommerce-get-url', 'dialogflow-get-token', 'subscribe-email', 'woocommerce-returning-visitor', 'push-notification', 'queue', 'update-conversation-status', 'update-users-last-activity', 'is-typing', 'send-message', 'set-typing', 'user-autodata', 'saved-replies' ]
    ];
