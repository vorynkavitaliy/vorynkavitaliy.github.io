...
function sb_get_active_user($db = false, $login_app = false) {
    global $SB_LOGIN;
    $return = false;
    if (isset($SB_LOGIN)) {
        $return = $SB_LOGIN;
...
function sb_get_block_setting($value) {
    switch ($value)  {
        ...
        case 'follow':
            ...
            return ['title' => sb_rich_value($settings['follow-title']), 'message' => sb_rich_value($settings['follow-msg']), 'name' => sb_rich_value($settings['follow-name']), 'last-name' => sb_rich_value(sb_isset($settings, 'follow-last-name')), 'success' => sb_rich_value($settings['follow-success']), 'placeholder' => sb_rich_value($settings['follow-placeholder'], false)];
        case 'subscribe':
